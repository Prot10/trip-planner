...
export const TOOL_META = {
  ...
  search_restaurants: { Icon: UtensilsCrossed, label: (a) => i18n.t('chat.tools.search_restaurants', { location: a.location ?? '' }) },
...
const GROUP_LABELS = {
  ...
  search_restaurants: (n) => i18n.t('chat.groups.search_restaurants', { count: n }),
